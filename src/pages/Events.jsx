...
import { heroImages } from '../monasteryData';
...
const Events = () => {
    ...
    const events = [
        {
            id: 1, name: 'Losar - Tibetan New Year', date: '2024-02-10', endDate: '2024-02-12',
            monastery: 'Rumtek Monastery', type: 'festival',
            description: 'Three-day celebration marking the Tibetan New Year with traditional dances, prayers, and community feasts.',
            duration: '3 days', significance: 'Most important festival in Tibetan Buddhism',
            activities: ['Cham Dance', 'Butter Lamp Offering', 'Community Feast', 'Prayer Ceremonies'],
            image: heroImages.events
        },
        {
            id: 2, name: 'Buddha Jayanti', date: '2024-05-23', monastery: 'All Monasteries',
            type: 'religious', description: 'Celebration of Lord Buddha\'s birth, enlightenment, and nirvana.',
            duration: '1 day', significance: 'Commemorates the three most important events in Buddha\'s life',
            activities: ['Special Prayers', 'Meditation Sessions', 'Teaching Discourses', 'Alms Giving'],
            image: 'https://images.unsplash.com/photo-1627449557458-1b63e63612d7?auto=format&fit=crop&q=80&w=2670&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        },
        {
            id: 3, name: 'Pang Lhabsol', date: '2024-08-15', monastery: 'Tashiding Monastery',
            type: 'festival', description: 'Festival dedicated to Mount Kanchenjunga and the guardian deities of Sikkim.',
            duration: '1 day', significance: 'Celebrates the unity between different communities of Sikkim',
            activities: ['Warrior Dance', 'Mountain Worship', 'Traditional Music', 'Cultural Programs'],
            image: 'https://images.unsplash.com/photo-1628155250493-27e6e5d8a9f6?auto=format&fit=crop&q=80&w=2670&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        },
        {
            id: 4, name: 'Saga Dawa', date: '2024-06-21', monastery: 'Pemayangtse Monastery',
            type: 'religious', description: 'Holy month culminating in the celebration of Buddha\'s enlightenment.',
            duration: '1 day', significance: 'Merit from good deeds multiplied 100,000 times',
            activities: ['Circumambulation', 'Prayer Flag Hoisting', 'Butter Lamp Lighting', 'Charitable Acts'],
            image: 'https://images.unsplash.com/photo-1549419142-2b28c8d8f0f3?auto=format&fit=crop&q=80&w=2670&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        },
        {
            id: 5, name: 'Drukpa Teshi', date: '2024-07-19', monastery: 'Enchey Monastery',
            type: 'religious', description: 'Celebrates Buddha\'s first teaching at Sarnath after his enlightenment.',
            duration: '1 day', significance: 'Marks the turning of the first wheel of dharma',
            activities: ['Scripture Reading', 'Dharma Discussions', 'Community Prayers', 'Teaching Sessions'],
            image: 'https://images.unsplash.com/photo-1628155250493-27e6e5d8a9f6?auto=format&fit=crop&q=80&w=2670&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        },
        {
            id: 6, name: 'Drupka Kunley Festival', date: '2024-09-28', monastery: 'Dubdi Monastery',
            type: 'festival', description: 'Celebration honoring the Divine Madman, Drukpa Kunley.',
            duration: '2 days', significance: 'Celebrates unconventional wisdom and spiritual freedom',
    ...
    return (
        <div className="page-section">
            <div className="container">
                <section className="hero" style={{ height: 'auto', padding: '3rem 0', margin: '2rem 0' }}>
                    <img src={heroImages.events} alt="Colorful Cham Dance at a Monastery Festival" className="hero-image" />
                        ...
                        <div className="card-grid">
                            {filteredEvents.map((event) => (
                                <div key={event.id} className="event-card card">
                                    <img src={event.image} alt={event.name} style={{ width: '100%', height: '200px', objectFit: 'cover', borderRadius: '8px' }} />
